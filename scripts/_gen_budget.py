"""Generate the budget-matched comparison script."""
from pathlib import Path

DEST = Path(__file__).resolve().parent / "run_nmnist_budget_matched_comparison_seed42.py"

content = r'''"""Budget-matched PGD vs TEMP-DRIFT-v2 comparison on frozen Seed-42 N-MNIST.
