...
Counts use each actual N-MNIST configuration, not generic architecture names.

| Model | Exact configured constructor | Trainable parameters |
|---|---|---:|
| **Custom SNN (ours)** | `NMNISTConvSNN(decay=0.5, n_classes=10)` | **25,482** |
| Paper **ConvNet** | `simplenet_v2(num_classes=10, img_size=(2,34,34), T=10)` | **299,264** |
| Paper **Spiking ResNet18** | `spiking_resnet18(num_classes=10, img_size=(2,34,34), T=10)` | **11,173,386** |
| Paper **VGGSNN** | `spiking_vggsnn(num_classes=10, img_size=(2,34,34), T=10)` | **9,227,786** |
